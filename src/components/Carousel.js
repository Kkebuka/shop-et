...
function Carousel() {
  return (
    <div className="container flex flex-col-reverse mx-auto border-2 h-[80%] border-black px-[10%] lg:flex-row lg:gap-14">
      <div className="flex flex-col lg:w-[45%] h-[100%] pt-16 space-y-8">
        ...
        <button className="w-36 mx-auto py-2">See Offers</button>
      </div>
