...
export default function SliderTestimonia() {
  useEffect(() => {
    ...
    if (keenSliderPreviousDesktop && keenSliderNextDesktop) {
  ...
  return (
    <section className="bg-gray-50">
      <div className="mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-12">
